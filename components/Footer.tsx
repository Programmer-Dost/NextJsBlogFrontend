      ...
      <div className='container mx-auto py-2 lg:py-2 flex items-center flex-col sm:flex-row md:py-8'>
        ...
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <a href="https://facebook.com/theprogrammerdost" className="text-gray-500">
                        <svg
                            fill="currentColor"
                            strokeLinecap="round"
                    ...
                    <a href="https://twitter.com/programmerdost" className="ml-3 text-gray-500">
                        <svg
                            fill="currentColor"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                    ...
                    <a href="https://www.instagram.com/programmerdost/" className="ml-3 text-gray-500">
                        <svg
                            fill="none"
                            stroke="currentColor"
                            strokeLinecap="round"
                    ...
                    <a href="https://www.linkedin.com/in/abhijeet-shukla-coder/"className="ml-3 text-gray-500">
                        <svg
                            fill="currentColor"
                            stroke="currentColor"
                            strokeLinecap="round"
